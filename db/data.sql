...
VALUES
    ...
    ------------------------------------------------
    ('En effet, j apprends beaucoup de choses nouvelles.', '2024-05-07 10:09:00', 4, 3),
    ('C est génial !', '2024-05-07 10:10:00', 3, 4),
    ('Et toi, que fais-tu ?', '2024-05-07 10:11:00', 4, 3),
    ('Je suis développeur web.', '2024-05-07 10:12:00', 3, 4),
    ('Ah, c est intéressant !', '2024-05-07 10:13:00', 4, 3),
    ('J adore créer des sites web et des applications.', '2024-05-07 10:14:00', 3, 4),
    ('Moi aussi ! C est très gratifiant de voir ses créations prendre vie.', '2024-05-07 10:15:00', 4, 3),
    ('Tout à fait !', '2024-05-07 10:16:00', 3, 4),
    ('Que fais-tu ce week-end ?', '2024-05-07 10:17:00', 4, 3),
    ('Je vais probablement faire une randonnée.', '2024-05-07 10:18:00', 3, 4),
    ('Ça a l air amusant !', '2024-05-07 10:19:00', 4, 3),
    ('Oui, tu veux te joindre à moi ?', '2024-05-07 10:20:00', 3, 4),
    ('Avec plaisir !', '2024-05-07 10:21:00', 4, 3),
    ('Super, rencontrons-nous à 8h.', '2024-05-07 10:22:00', 3, 4),
    ('D accord, à samedi !', '2024-05-07 10:23:00', 4, 3),
    ('Tu as reçu les documents pour le projet ?', '2024-05-07 10:24:00', 3, 4),
    ('Oui, je les ai reçus hier.', '2024-05-07 10:25:00', 4, 3),
    ('Parfait, nous pourrons commencer lundi.', '2024-05-07 10:26:00', 3, 4),
    ('Ça me va.', '2024-05-07 10:27:00', 4, 3),
    ('As-tu des questions sur le projet ?', '2024-05-07 10:28:00', 3, 4),
    ('Non, tout est clair pour moi.', '2024-05-07 10:29:00', 4, 3),
    ('Très bien, on se voit lundi alors.', '2024-05-07 10:30:00', 3, 4),
    ('À lundi !', '2024-05-07 10:31:00', 4, 3),
    ('Bonjour Alice, comment ça va aujourd hui ?', '2024-05-08 09:00:00', 3, 4),
    ('Bonjour Bob, je vais bien, merci. Et toi ?', '2024-05-08 09:01:00', 4, 3),
    ('Je vais bien aussi.', '2024-05-08 09:02:00', 3, 4),
    ('As-tu eu le temps de regarder le document que je t ai envoyé ?', '2024-05-08 09:03:00', 4, 3),
    ('Oui, je l ai lu hier soir.', '2024-05-08 09:04:00', 3, 4),
    ('Qu en penses-tu ?', '2024-05-08 09:05:00', 4, 3),
    ('C est très complet. Beau travail, Alice.', '2024-05-08 09:06:00', 3, 4),
    -------------------------------------------------
